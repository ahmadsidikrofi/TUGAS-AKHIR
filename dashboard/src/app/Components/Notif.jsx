...
const Notif = () => {
  ...
  return (
    <div className=" border cursor-pointer rounded-full hover:bg-gray-100 justify-center items-center py-1 px-2">
      <Sheet>
        {jumlah > 12 ? (
          <SheetTrigger>
          ...
          <SheetTrigger>
            ...
            <div className="w-3 h-3 bg-red-500 rounded-full absolute right-27 top-11 "></div>
          </SheetTrigger>
        )}
